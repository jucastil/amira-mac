...
/// @{
#ifndef HX_TET_TO_HEX
#define HX_TET_TO_HEX
...
/// Converts a tetrahedral grid into a hexahedral one.
class HXHEXA_API HxTetToHex : public HxCompModule {

  HX_HEADER(HxTetToHex);
