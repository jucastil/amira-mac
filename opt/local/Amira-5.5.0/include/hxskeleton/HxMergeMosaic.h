...
/// @{
#ifndef HX_MERGEMOSAIC_H
#define HX_MERGEMOSAIC_H
...
/** Takes an HxMosaic as input and samples all the bricks onto a HxLDAfile.
  ...
  */
class HXSKELETON_API HxMergeMosaic : public HxCompModule {

    HX_HEADER (HxMergeMosaic);
    ...
    public:
        ...
        void sampleAll (HxMosaic* src, HxMutableLattice* res
                              , int interpol = 1, int blend = 0, int samplemask = 0);
