...
/// @{
#ifndef HX_EXT_EVAL_ON_LINES
#define HX_EXT_EVAL_ON_LINES
...
/** The module loads the lda block by block and calculates
  ...
  */
class HXSKELETON_API HxExtEvalOnLines : public HxCompModule {

    HX_HEADER (HxExtEvalOnLines);
