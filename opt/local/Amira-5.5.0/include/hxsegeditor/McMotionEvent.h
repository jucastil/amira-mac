...
/// @{
#ifndef MC_MOTION_EVENT_H
#define MC_MOTION_EVENT_H

#include "McEvent.h"
#include "HxGiWinDLLApi.h"

/// Represents motion events, e.g. of a 2D mouse.
class HXSEGEDITOR_API McMotionEvent : public McEvent {
