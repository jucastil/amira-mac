...
/// @{
#ifndef  MC_LEAVE_WINDOW_EVENT_H
#define  MC_LEAVE_WINDOW_EVENT_H

#include "McButtonEvent.h"
#include "HxGiWinDLLApi.h"

///
class HXSEGEDITOR_API McLeaveWindowEvent : public McEvent {
  ...
  public:
    ...
    /// Destructor.
    virtual ~McLeaveWindowEvent() {}

    /// Returns type of McLeaveWindowEvent class.
