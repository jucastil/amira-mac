...
/// @{
#ifndef MC_FOOT_EVENT_H
#define MC_FOOT_EVENT_H

#include "McEvent.h"

/// Represents en event of Malte's foot device.
class McFootEvent : public McEvent {
  ...
  public:
    ...
    /// Set value.
    void setValue(int b) { value = b; }

    /// Set value (this is a continuous device).
