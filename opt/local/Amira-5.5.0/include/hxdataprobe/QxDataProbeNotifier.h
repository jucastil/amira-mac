...
/// @{
#ifndef QX_DATA_PROBE_NOTIFIER
#define QX_DATA_PROBE_NOTIFIER

#include <qobject.h>
#include "HxDataProbe.h"

class QxDataProbeNotifier : public QObject {

   Q_OBJECT

  public:
    QxDataProbeNotifier( HxDataProbe* o )
        : mOwner(o) {}
