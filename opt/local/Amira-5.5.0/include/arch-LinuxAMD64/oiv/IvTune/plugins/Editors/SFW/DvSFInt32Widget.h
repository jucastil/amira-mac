...
** Author      : VSG (MMM YYYY)
**=======================================================================*/
#ifndef DvSFINT32WIDGET_H
#define DvSFINT32WIDGET_H
...
//////////////////////////////////////////////////////////////////////////////
//
//  Class: DvSFInt32Widget
//
//////////////////////////////////////////////////////////////////////////////

class DEMOVIEWER_API DvSFInt32Widget : public DvSFieldWidget
{
...
public:
   ...
   * Default constructor.
   */
  DvSFInt32Widget(DvRangeComponent &rangeSet, DvFieldEditorCommandManager * manager, 
   ...
   */
	DvSFInt32Widget( const char *fieldName, DvRangeComponent &rangeSet, 
