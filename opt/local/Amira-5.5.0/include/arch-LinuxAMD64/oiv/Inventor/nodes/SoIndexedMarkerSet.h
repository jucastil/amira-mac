...
**=======================================================================*/
                                                             ...
                                                             /* include files */
#ifndef _SO_INDEXED_MARKER_SET_
#define _SO_INDEXED_MARKER_SET_
...
/**
 * @VSGEXT Extension of IndexedPointSet that draws a small bitmap (symbol) at each 3D location.
 * 
 * @ingroup ShapeNodes
 * 
 * @DESCRIPTION
 ...
 *   #vertexProperty field is recommended.  The coordinate of each marker is
 *   specified by the #coordIndex field which indexes into the list of coordinates.
 *   The number of markers is the number of values in the coordIndex field.
 *
 ...
 *
 *   Depending on the current material and normal binding values, the materials and
 *   normals for the vertices may be accessed in order or indexed. If they are 
 *   indexed, the materialIndex and normalIndex fields are used. Treatment of the 
 *   current material and normal binding is as follows: PER_PART, PER_FACE, and 
 *   PER_VERTEX bindings bind one material or normal to each point. The default 
...
class INVENTOR_API SoIndexedMarkerSet : public SoIndexedPointSet {
...
inline SbBool 
SoIndexedMarkerSet::isRenderingPointsOrLines(SoGLRenderAction *)
{
  return TRUE;
}

#endif /* _SO_INDEXED_MARKER_SET_ */
