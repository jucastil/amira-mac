...
#ifndef _SOSUNIMAGERW_
#define _SOSUNIMAGERW_
...
/**
 *
 * @VSGEXT Class for encoding and decoding a SUN raster image
 * 
 * @ingroup Image
 *
 * This class is used for encoding and decoding a SUN (.ras) raster image.
 *
 ...
 * 
 */ 
class INVENTOR_API SoSUNImageRW : public SoRasterImageRW {
