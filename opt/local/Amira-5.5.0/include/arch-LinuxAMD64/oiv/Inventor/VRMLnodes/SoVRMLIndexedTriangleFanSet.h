...
#ifndef  _SO_VRMLINDEXEDTRIANGLE_FAN_SET_
#define  _SO_VRMLINDEXEDTRIANGLE_FAN_SET_
...
//
// An SoVRMLIndexedTriangleFanSet represents a 3D shape composed of strips
// of triangles that form a fan shape around the first vertex declared 
// in each fan.
//
//////////////////////////////////////////////////////////////////////////////
...
/**
 * Indexed triangle fan set shape node.\ @NO_ACTION
 * 
 * @ingroup X3D
 * 
 * @DESCRIPTION
 ...
 *
 *   An SoVRMLIndexedTriangleFanSet represents a 3D shape composed of 
 *   triangles that form a fan shape around the first vertex declared in 
 *   each fan, as depicted in the following figure.
 *   
 *   @IMAGE TriangleFanSet.jpg
 *
 *
 *   An SoVRMLIndexedTriangleFanSet uses the indices in its #index field 
 *   to specify the triangle fans by connecting vertices from the #coord 
 *   field. An index of "-1" indicates that the current fan has ended and 
 *   the next one begins. The last fan may be (but does not have to be) 
 *   followed by a "-1". Each fan shall must have at least three non-coincident 
 *   vertices.
 *
 *   The SoVRMLIndexedTriangleFanSet node is specified in the local 
 ...
 *   
 *   The #solid field determines whether the IndexedTriangleFanSet is visible 
 *   when viewed from the inside.
 *
 * 
 * @FILE_FORMAT_DEFAULT
 *    VRMLIndexedTriangleFanSet {
 *    @TABLE_FILE_FORMAT
 *       @TR color             @TD NULL
 *       @TR coord             @TD NULL
 *       @TR normal            @TD NULL
...
class INVENTOR_API SoVRMLIndexedTriangleFanSet : public SoVRMLTriangle {
  
  SO_NODE_HEADER(SoVRMLIndexedTriangleFanSet);
 ...
 protected:
  ...
  virtual ~SoVRMLIndexedTriangleFanSet();
...
#endif /* _SO_VRMLINDEXEDTRIANGLE_FAN_SET_ */
