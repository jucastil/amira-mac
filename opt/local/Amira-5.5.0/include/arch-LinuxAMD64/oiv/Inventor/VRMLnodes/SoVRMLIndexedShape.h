...
#ifndef  _SO_VRMLINDEXED_SHAPE_
#define  _SO_VRMLINDEXED_SHAPE_
...
/**
 * @VSGEXT Abstract base class for SoVRMLIndexedFaceSet.
 * 
 * @ingroup VRML2
 * 
 * @DESCRIPTION
 ...
 * 
 *    @TABLE_EVENT_OUT      
 *       @TR   SoMFInt32   @TD   colorIndex_changed      
 *       @TR   SoMFInt32   @TD   coordIndex_changed      
 *       @TR   SoMFInt32   @TD   normalIndex_changed      
 *       @TR   SoMFInt32   @TD   texCoordIndex_changed
...
class INVENTOR_API SoVRMLIndexedShape : public SoVRMLVertexShape {

  SO_NODE_ABSTRACT_HEADER(SoVRMLIndexedShape);

 public:
  /**
   * Indices of the coordinates that the indexed face set uses as its vertices. The
   * coordinates connect to form the faces.
   * 
   */
  SoMFInt32           coordIndex;
  /**
   * The indices of the colors to use for the faces or vertices depending on the
   * value of the @B colorPerVertex @b field. If NULL, the colors are applied to
   * each face of the SoVRMLIndexedFaceSet in order.
   * 
   */
  SoMFInt32           colorIndex;
  /**
   * The indices of the normals to use for the faces or vertices depending onthe
   * value of the @B normalPerVertex @b field. If NULL, the normals are applied to
   * each face of the SoVRMLIndexedFaceSet in order.
   * 
   */
   ...
   * SoVRMLIndexedFaceSet. If this field is NULL, the #coordIndex field is used
   * to choose texture coordinates from the texture coordinate node.
   * 
   */
