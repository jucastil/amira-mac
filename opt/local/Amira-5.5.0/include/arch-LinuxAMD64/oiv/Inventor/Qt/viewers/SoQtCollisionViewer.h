...
#ifndef _SO_QT_COLLISION_VIEWER_
#define _SO_QT_COLLISION_VIEWER_
...
//------------------------------------------------------------------------------
// Types definition
typedef void SoQtCollisionViewerCB 
(void *userData, SoQtCollisionViewer *collisionViewer);
...
class INVENTORQT_API SoQtCollisionViewer
{
...
private : 
  ...
  onSlowCollisionCB(void *ud, 
                    ...
                    const SoIntersectingPrimitive *) {
    return ((SoQtCollisionViewer *) ud)->onSlowCollision ();
  }

  static SbBool 
  slowFilterCB(void *ud, const SoPath *p1, const SoPath *p2) {
    return ((SoQtCollisionViewer *)ud)->slowFilter (p1, p2);
  }

  static void 
  onRenderCB(void *ud, SoSceneManager *) {
    ((SoQtCollisionViewer *)ud)->onRender ();
  }
  ...
  onFoundCameraCB(void *ud, 
                  ...
                  const SoNode *node) {
    return ((SoQtCollisionViewer*) ud)->onFoundCamera (action, node);
  }


};

#endif//_SO_QT_COLLISION_VIEWER_
