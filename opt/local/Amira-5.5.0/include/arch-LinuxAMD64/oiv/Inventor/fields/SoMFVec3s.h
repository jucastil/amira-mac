...
#ifndef  _SO_MF_VEC3S_
#define  _SO_MF_VEC3S_
...
//////////////////////////////////////////////////////////////////////////////
//
//  SoMFVec3s subclass of SoMField.
//
//////////////////////////////////////////////////////////////////////////////
...
*   
*   SoMFVec3ss are written to file as one or more triples of short values
...
class INVENTOR_API SoMFVec3s : public SoMField {
   ...
   * [OIVNET-WRAPPER-ARG IN,NO_WRAP{(vec3f != NULL? vec3f->get_Length(): 0)},ARRAY]
   * [OIVNET-WRAPPER-HELPER BEGIN{OnSetValues(start, vec3f != NULL? vec3f->get_Length(): 0)}]
   */
