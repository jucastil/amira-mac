...
#ifndef  _SO_MF_VEC2I32_
#define  _SO_MF_VEC2I32_
...
//////////////////////////////////////////////////////////////////////////////
//
//  SoMFVec2i32 subclass of SoMField.
//
//////////////////////////////////////////////////////////////////////////////
...
*   
*   SoMFVec2i32s are written to file as one or more pairs of integer values
...
class INVENTOR_API SoMFVec2i32 : public SoMField {
   ...
   * [OIVNET-WRAPPER-ARG IN,NO_WRAP{vec2f->Length},ARRAY]
   * [OIVNET-WRAPPER-HELPER BEGIN{OnSetValues(start, vec2f->Length)}]
   */
