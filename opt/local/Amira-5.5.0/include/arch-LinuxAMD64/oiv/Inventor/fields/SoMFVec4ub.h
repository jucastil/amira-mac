...
#ifndef  _SO_MF_VEC4UB_
#define  _SO_MF_VEC4UB_
...
//////////////////////////////////////////////////////////////////////////////
//
//  SoMFVec4ub subclass of SoMField.
//
//////////////////////////////////////////////////////////////////////////////
...
*   
*   SoMFVec4ubs are written to file as one or more quadruplets of unsigned char values
...
class INVENTOR_API SoMFVec4ub : public SoMField {
  // Use standard field stuff
  SO_MFIELD_HEADER(SoMFVec4ub, SbVec4ub, const SbVec4ub &);
  
  SO_MFIELD_SETVALUESPOINTER_HEADER(unsigned char);
