...
typedef HPDF_HANDLE   HPDF_3DView;
typedef HPDF_HANDLE   HPDF_3DBackground;
...
HPDF_EXPORT(HPDF_3DView)
HPDF_U3D_Create3DView (HPDF_Doc pdf, 
                       HPDF_U3D u3d, 
                       const char* name,
                       HPDF_BOOL useAsDefault);

HPDF_EXPORT(HPDF_STATUS)
HPDF_3DView_SetPerspective (HPDF_Doc pdf, 
                            HPDF_3DView view, 
                            HPDF_BOOL hasPerspective, 
                            float fov);

HPDF_EXPORT(HPDF_STATUS)
HPDF_3DView_SetFocalDistance (HPDF_3DView view, 
                              float dist);

HPDF_EXPORT(HPDF_STATUS)
HPDF_3DView_SetMatrixFromU3D (HPDF_Doc pdf, 
                              HPDF_3DView view, 
                              const char* node);

HPDF_EXPORT(HPDF_STATUS)
HPDF_3DView_SetLightingScheme (HPDF_Doc pdf, 
                               HPDF_3DView view, 
                               const char* style);

HPDF_EXPORT(HPDF_3DBackground)
HPDF_3DView_Create3DBackground (HPDF_Doc pdf, 
                                HPDF_3DView view);

HPDF_EXPORT(HPDF_STATUS)
HPDF_3DBackground_SetSolidColor (HPDF_3DBackground bg, 
                                 float r, 
                                 float g, 
                                 float b);
