...
**=======================================================================*/
#ifndef  _SO_DIALOG_CHECK_LAUNCHER_
#define  _SO_DIALOG_CHECK_LAUNCHER_

#include <DialogViz/dialog/SoDialogCheckBox.h>
#include <DialogViz/dialog/SoTopLevelDialog.h>

/**
 * @VSGEXT Dialog CheckBoxLauncher node.
 * 
 * @ingroup Dialog
 * 
 * @DESCRIPTION
 *   This node defines a check box component for the dialog with a special
 ...
 * 
 * @FILE_FORMAT_DEFAULT
 *   DialogCheckBoxLauncher {
 *   @TABLE_FILE_FORMAT
 *       @TR // fields from SoDialogCheckBox
 *       @TR state            @TD FALSE
 *       @TR onString         @TD "On"
 *       @TR offString        @TD "Off"
 ...
 * 
 * @CATALOG_PARTS
 * @ref SoDialogCheckBox_CatalogParts @BR
 *
 * @SEE_ALSO
 *   SoDialogCheckBox,
...
class DIALOGVIZ_API SoDialogCheckBoxLauncher : public SoDialogCheckBox  
{

  SO_DG_HEADER(SoDialogCheckBoxLauncher);
  ...
  */
  ...
  /**
   * Retrieves the DialogViz object from the specified auditorID field in an SoDialogCheckBoxLauncher
...
protected:
  ...
  virtual ~SoDialogCheckBoxLauncher();
...
#endif // _SO_DIALOG_CHECK_LAUNCHER_
