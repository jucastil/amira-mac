...
/// @{
#ifndef _VS_LINEREN_H_
#define _VS_LINEREN_H_
...
// VS_RELAY_CLASS VsLineRen VsNodeRelay


class VSVOLREN_API VsLineRen : public VsNode
{
    VS_DECL_INTERFACE        ( VsLineRen )
    VS_DECL_INTERFACE_IMPL   ( VsLineRen )
    VS_DECL_INTERFACE_FACTORY( VsLineRen )
    VS_DECL_INTERFACE_RELAY  ( VsLineRen )

public:

    /** Color mode  */
    enum ColorMode {
        CMODE_CONSTANT,  /** Render lineset with constant color*/
        CMODE_DATA0,     /** Render lineset by looking up data value 0 in a color table*/
        CMODE_DATA1,     /** Render lineset by looking up data value 1 in a color table*/
        CMODE_DATA2,     /** Render lineset by looking up data value 2 in a color table*/
        CMODE_DEC        /** Render lineset with direction encoded color*/
    };
    ...
    */
    virtual VsLineSet * lineSet( int iLineSet = 0 );
    ...
    * \return
    */
    virtual VSRESULT clearLineSets();
