...
/// @{
#ifndef VS_REMOTE_RENDERER
#define VS_REMOTE_RENDERER
...
{
    VS_DECL_INTERFACE        ( VsRemoteRenderer )
    VS_DECL_INTERFACE_IMPL   ( VsRemoteRenderer )
    // VS_DECL_INTERFACE_FACTORY( VsRemoteRenderer )
...
public:
    ...
    // renders into inScene->backgroundImage()
    ...
    static void setViewPortAutoScaleRange( float inMin, float inMax );
    static void viewPortAutoScaleRange( float & outMin, float & outMax );
};

#endif // VS_REMOTE_RENDERER
