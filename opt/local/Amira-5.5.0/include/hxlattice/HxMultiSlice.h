...
/// @{
#ifndef HX_MULTISLICE
#define HX_MULTISLICE
...
class HXLATTICE_API HxMultiSlice : public HxOverlayModule {

  HX_HEADER(HxMultiSlice);
  ...
  public:
    ...
    ///
    virtual void extractSlice(SbVec3f orig,SbVec3f uVec, SbVec3f vVec);
    ...
    virtual void setViewerMask(int mask = 0xffff, int mastr=0xffff);

  protected:
    virtual ~HxMultiSlice();
    float* scalar;
    int lock;
    HxObliqueSlice		*master;
    HxScalarField3	*field;
    HxColormap		*colormap;
    unsigned char       *texData;
    SbVec2s             size;
    SbVec3f orig, uVec,  vVec;
    friend class HxObliqueSlice;
};
