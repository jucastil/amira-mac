...
/// @{
#ifndef SURF_EDIT_REFINE_H
#define SURF_EDIT_REFINE_H

#include <mclib/McBitfield.h>
#include "SurfEditTool.h"
#include "SurfaceUndo.h"

/// Tool for refining parts of the surface
class SurfEditRefine : public SurfEditTool {

  public:
    SurfEditRefine(HxSurfEdit* surfEdit);
