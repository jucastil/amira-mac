...
/// @{
#ifndef _HxMagDipol_h_
#define _HxMagDipol_h_
...
class HXVECTOR_API HxMagDipol : public HxVectorField3 {

  HX_HEADER(HxMagDipol);
  ...
  public:
    ...
    /// Data objects only have an update() method, but no compute().
    virtual void update();

    /// Angle of dipole axis relative to z-axis.
    HxPortFloatSlider portPhi;

    /// Magnitude of homogene magnetic field.
    HxPortFloatSlider portB;
  ...
  protected:
    ...
    static int eval(HxMagDipol*, HxLocation3*, float*);
};
