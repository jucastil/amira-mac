...
/// @{
#ifndef HX_LINEAR_VECTORFIELD3_H
#define HX_LINEAR_VECTORFIELD3_H
...
class HXVECTOR_API HxLinearVectorField3 : public HxVectorField3 {

  HX_HEADER(HxLinearVectorField3);

  public:
    /// Constructor.
    HxLinearVectorField3();
  ...
  protected:
    virtual ~HxLinearVectorField3();

    float A[3][4];
    static int eval(HxLinearVectorField3*, HxLocation3*, float*);
};
