...
/// @{
#ifndef HXTRACKD_API_H
#define HXTRACKD_API_H

#include <hxtrackd/HxTrackingSystem.h>

/// Provides access to the native trackdAPI library.
class HXTRACKD_API HxTrackdAPI : public HxTrackingSystem
{
  public:
    /// Constructor.
    HxTrackdAPI(int controllerKey, int trackerKey);
