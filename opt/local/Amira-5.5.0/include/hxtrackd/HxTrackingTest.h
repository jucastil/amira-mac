...
/// @{
#ifndef HXTRACKING_TEST_H
#define HXTRACKING_TEST_H

#include <hxtrackd/hxtrackd.h>
#include <hxcore/HxController.h>
#include <hxtrackd/HxTrackingSystem.h>

class HXTRACKD_API HxTrackingTest : public HxTrackingSystem
{
  public:
    HxTrackingTest();

    virtual ~HxTrackingTest();
  ...
  protected:
    ...
    static SbBool eventCallback(const SoEvent* event,
        HxViewer* viewer, void* userData);
};
