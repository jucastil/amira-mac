...
/// @{
#ifndef HX_CLUSTER_LABEL
#define HX_CLUSTER_LABEL
...
class HxClusterLabel : public HxModule {
  HX_HEADER(HxClusterLabel);
...
protected:
  HxPortMultiMenu portLabelColumns;

  HxPortColorList portColor;

  HxPortIntSlider portFontSize;

  McHandle<SoAnnotation> root;
  SoText2Set* labelSet;
};
