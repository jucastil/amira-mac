...
/// @{
#ifndef SO_TRANSFORMER_DRAGGER_VR_H
#define SO_TRANSFORMER_DRAGGER_VR_H
...
class HXCORE_API SoTransformerDraggerVR : public SoTransformerDragger
{
  public:
    SoTransformerDraggerVR();
  ...
  protected:
    virtual ~SoTransformerDraggerVR();

    void grab(SoHandleEventAction* action);

    unsigned int grab3D:1;
    unsigned int grabOIV:1;
