...
/// @{
#ifndef _SO_CHECKER_BACKGROUND_H_
#define _SO_CHECKER_BACKGROUND_H_
...
class HXCORE_API SoCheckerBackground : public SoBackground {

   SO_NODE_HEADER(SoCheckerBackground);

 public:
   // Fields:
   // 
  /**
   * First color in Checker (0.7 0.7 0.8 by default).
   */
   SoSFColor    color0;
  /**
   * Second color in Checker (0.0 0.1 0.3 by default).
   */
   SoSFColor    color1;

  /**
   * Creates a background Checker node with default settings.
   */
   SoCheckerBackground();
 ...
 protected:
   ...
   virtual ~SoCheckerBackground();

 private:
};

#endif //SoCheckerBackground
