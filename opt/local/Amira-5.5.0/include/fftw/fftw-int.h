...
extern FFTW_API fftw_twiddle *fftw_create_twiddle(int n, const fftw_codelet_desc *d);
extern FFTW_API void fftw_destroy_twiddle(fftw_twiddle *tw);

extern FFTW_API void fftw_strided_copy(int, fftw_complex *, int, fftw_complex *);
extern FFTW_API void fftw_executor_simple(int, const fftw_complex *, fftw_complex *,
				 fftw_plan_node *, int, int,
				 fftw_recurse_kind recurse_kind);

extern FFTW_API fftwnd_plan fftwnd_create_plan_aux(int rank, const int *n,
					  fftw_direction dir, int flags);
extern FFTW_API fftw_plan *fftwnd_new_plan_array(int rank);
extern FFTW_API fftw_plan *fftwnd_create_plans_generic(fftw_plan *plans,
					      int rank, const int *n,
					      fftw_direction dir, int flags);
extern FFTW_API fftw_plan *fftwnd_create_plans_specific(fftw_plan *plans,
					       int rank, const int *n,
					       const int *n_after,
					       fftw_direction dir, int flags,
					       fftw_complex *in, int istride,
					       fftw_complex *out, int ostride);
extern FFTW_API int fftwnd_work_size(int rank, const int *n, int flags, int ncopies);

extern FFTW_API void fftwnd_aux(fftwnd_plan p, int cur_dim,
		       fftw_complex *in, int istride,
		       fftw_complex *out, int ostride,
		       fftw_complex *work);
extern FFTW_API void fftwnd_aux_howmany(fftwnd_plan p, int cur_dim,
			       int howmany,
...
extern FFTW_API int fftw_wisdom_lookup(int n, int flags, fftw_direction dir,
			      enum fftw_wisdom_category category,
			      int istride, int ostride,
			      enum fftw_node_type *type,
			      int *signature,
			      fftw_recurse_kind *recurse_kind, int replace_p);
extern FFTW_API void fftw_wisdom_add(int n, int flags, fftw_direction dir,
...
extern FFTW_API double fftw_estimate_node(fftw_plan_node *p);
extern FFTW_API fftw_plan_node *fftw_make_node_notw(int size,
					const fftw_codelet_desc *config);
extern FFTW_API fftw_plan_node *fftw_make_node_real2hc(int size,
					const fftw_codelet_desc *config);
extern FFTW_API fftw_plan_node *fftw_make_node_hc2real(int size,
					const fftw_codelet_desc *config);
extern FFTW_API fftw_plan_node *fftw_make_node_twiddle(int n,
					 const fftw_codelet_desc *config,
					      fftw_plan_node *recurse,
					      int flags);
extern FFTW_API fftw_plan_node *fftw_make_node_hc2hc(int n,
					    fftw_direction dir,
					 const fftw_codelet_desc *config,
					    fftw_plan_node *recurse,
					    int flags);
extern FFTW_API fftw_plan_node *fftw_make_node_generic(int n, int size,
					      fftw_generic_codelet *codelet,
					      fftw_plan_node *recurse,
					      int flags);
extern FFTW_API fftw_plan_node *fftw_make_node_rgeneric(int n, int size,
					       fftw_direction dir,
					       fftw_rgeneric_codelet * codelet,
					       fftw_plan_node *recurse,
					       int flags);
extern FFTW_API int fftw_factor(int n);
extern FFTW_API fftw_plan_node *fftw_make_node(void);
extern FFTW_API fftw_plan fftw_make_plan(int n, fftw_direction dir,
				fftw_plan_node *root, int flags,
				enum fftw_node_type wisdom_type,
				int wisdom_signature,
				fftw_recurse_kind recurse_kind,
				int vector_size);
extern FFTW_API void fftw_use_plan(fftw_plan p);
extern FFTW_API void fftw_use_node(fftw_plan_node *p);
extern FFTW_API void fftw_destroy_plan_internal(fftw_plan p);
extern FFTW_API fftw_plan fftw_pick_better(fftw_plan p1, fftw_plan p2);
extern FFTW_API fftw_plan fftw_lookup(fftw_plan *table, int n, int flags,
			     int vector_size);
extern FFTW_API void fftw_insert(fftw_plan *table, fftw_plan this_plan);
extern FFTW_API void fftw_make_empty_table(fftw_plan *table);
extern FFTW_API void fftw_destroy_table(fftw_plan *table);
extern FFTW_API void fftw_complete_twiddle(fftw_plan_node *p, int n);

extern FFTW_API fftw_plan_node *fftw_make_node_rader(int n, int size,
					    fftw_direction dir,
					    fftw_plan_node *recurse,
					    int flags);
extern FFTW_API fftw_rader_data *fftw_rader_top;

/* undocumented debugging hook */
typedef void (*fftw_plan_hook_ptr) (fftw_plan plan);

// This header file is included from both the fftw and rfftw projects!

#ifdef FFTW_API
extern FFTW_API fftw_plan_hook_ptr fftw_plan_hook;
#endif

#ifdef RFFTW_API
extern RFFTW_API fftw_plan_hook_ptr rfftw_plan_hook;
#endif
...
extern FFTW_API int fftw_safe_mulmod(int x, int y, int p);
#endif
...
extern FFTW_API fftw_time fftw_gettimeofday_get_time(void);
extern FFTW_API fftw_time fftw_gettimeofday_time_diff(fftw_time t1, fftw_time t2);
...
extern FFTW_API fftw_time get_Mac_microseconds(void);

#define fftw_get_time() get_Mac_microseconds()

/* define as a function instead of a macro: */
extern FFTW_API fftw_time fftw_time_diff(fftw_time t1, fftw_time t2);
...
extern FFTW_API unsigned long GetPerfTime(void);
extern FFTW_API double GetPerfSec(double ticks);
...
extern FFTW_API long clock(void);
