...
extern FFTW_API const char*  fftw_version;
...
extern FFTW_API fftw_plan fftw_create_plan_specific(int n, fftw_direction dir,
					   int flags,
					   fftw_complex *in, int istride,
					 fftw_complex *out, int ostride);
#define FFTW_HAS_PLAN_SPECIFIC
extern FFTW_API fftw_plan fftw_create_plan(int n, fftw_direction dir, int flags);
extern FFTW_API void fftw_print_plan(fftw_plan plan);
extern FFTW_API void fftw_destroy_plan(fftw_plan plan);
extern FFTW_API void fftw(fftw_plan plan, int howmany, fftw_complex *in, int istride,
		 int idist, fftw_complex *out, int ostride, int odist);
extern FFTW_API void fftw_one(fftw_plan plan, fftw_complex *in, fftw_complex *out);
extern FFTW_API void fftw_die(const char *s);
extern FFTW_API void *fftw_malloc(size_t n);
extern FFTW_API void fftw_free(void *p);
extern FFTW_API void fftw_check_memory_leaks(void);
extern FFTW_API void fftw_print_max_memory_usage(void);

typedef FFTW_API void *(*fftw_malloc_type_function) (size_t n);
typedef FFTW_API void  (*fftw_free_type_function) (void *p);
typedef FFTW_API void  (*fftw_die_type_function) (const char *errString);
extern FFTW_API fftw_malloc_type_function fftw_malloc_hook;
extern FFTW_API fftw_free_type_function fftw_free_hook;
extern FFTW_API fftw_die_type_function fftw_die_hook;

extern FFTW_API size_t fftw_sizeof_fftw_real(void);
...
extern FFTW_API void fftw_forget_wisdom(void);
extern FFTW_API void fftw_export_wisdom(void (*emitter) (char c, void *), void *data);
extern FFTW_API fftw_status fftw_import_wisdom(int (*g) (void *), void *data);
extern FFTW_API void fftw_export_wisdom_to_file(FILE *output_file);
extern FFTW_API fftw_status fftw_import_wisdom_from_file(FILE *input_file);
extern FFTW_API char *fftw_export_wisdom_to_string(void);
extern FFTW_API fftw_status fftw_import_wisdom_from_string(const char *input_string);
...
extern FFTW_API void fftw_fprint_plan(FILE *f, fftw_plan plan);
...
extern FFTW_API fftwnd_plan fftw2d_create_plan(int nx, int ny, fftw_direction dir,
				      int flags);
extern FFTW_API fftwnd_plan fftw3d_create_plan(int nx, int ny, int nz,
				      fftw_direction dir, int flags);
extern FFTW_API fftwnd_plan fftwnd_create_plan(int rank, const int *n,
				      fftw_direction dir,
				      int flags);

extern FFTW_API fftwnd_plan fftw2d_create_plan_specific(int nx, int ny,
					       fftw_direction dir,
					       int flags,
					   fftw_complex *in, int istride,
					 fftw_complex *out, int ostride);
extern FFTW_API fftwnd_plan fftw3d_create_plan_specific(int nx, int ny, int nz,
					   fftw_direction dir, int flags,
					   fftw_complex *in, int istride,
					 fftw_complex *out, int ostride);
extern FFTW_API fftwnd_plan fftwnd_create_plan_specific(int rank, const int *n,
					       fftw_direction dir,
					       int flags,
					   fftw_complex *in, int istride,
					 fftw_complex *out, int ostride);
...
extern FFTW_API void fftwnd_destroy_plan(fftwnd_plan plan);

/* Printing the plan: */
extern FFTW_API void fftwnd_fprint_plan(FILE *f, fftwnd_plan p);
extern FFTW_API void fftwnd_print_plan(fftwnd_plan p);
#define FFTWND_HAS_PRINT_PLAN

/* Computing the N-Dimensional FFT */
extern FFTW_API void fftwnd(fftwnd_plan plan, int howmany,
		   fftw_complex *in, int istride, int idist,
		   fftw_complex *out, int ostride, int odist);
extern FFTW_API void fftwnd_one(fftwnd_plan p, fftw_complex *in, fftw_complex *out);
