...
extern FFTW_API pthread_attr_t *fftw_pthread_attributes_p;
...
extern FFTW_API void fftw_thread_spawn_loop(int loopmax, int nthreads,
				   fftw_loop_function proc, void *data);

extern FFTW_API void fftw_executor_many_inplace_threads(int n, fftw_complex *in,
					       fftw_complex *work,
					       fftw_plan_node *p,
					       int istride,
