...
/// @{
#ifndef HX_NONCOVALENTINTERACTIONGRID_H
#define HX_NONCOVALENTINTERACTIONGRID_H
...
class HXMOLEDIT_API HxNoncovalentInteractionGrid : public HxCompModule {

    HX_HEADER(HxNoncovalentInteractionGrid);
    
public:
    /// Constructor.
    HxNoncovalentInteractionGrid();
  
    /// Destructor.
    virtual ~HxNoncovalentInteractionGrid();
    ...
    HxPortMultiMenu portAtomType;
    HxPortFloatSlider portAtomCharge;
    HxPortToggleList portWhichEnergy;
