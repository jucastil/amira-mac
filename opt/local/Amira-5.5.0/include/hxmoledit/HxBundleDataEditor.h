...
/// @{
#ifndef HX_BundleData_EDITOR_H
#define HX_BundleData_EDITOR_H
...
class QxBundleDataEditor;
class QxEditorNotifier;
class readOperation;
class MtGroupData;

/** HxBundleDataEditor is the interface between the
    outside world and the QT user interface 
    as implemented in QxBundleDataEditor. It
    ...
    Amira. The QxBundleDataEditor will be created as soon
    ...
    signal of the QxBundleDataEditor on to this object
**/

class HXMOLEDIT_API HxBundleDataEditor : public HxEditor, public ComputeListener {

    HX_HEADER(HxBundleDataEditor);
...
public:
    ...
    /// function used for compute event callbacks
    virtual void computeCalled(HxObject* o);
