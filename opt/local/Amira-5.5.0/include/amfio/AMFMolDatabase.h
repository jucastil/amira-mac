...
/// @{
#ifndef MOL_TRAJECTORYAMF_H
#define MOL_TRAJECTORYAMF_H
...
/** class MolTrajectoryAMF is an Amira Data class
    used to buffer AMF trajectories. 
    The Topology is only read once.
    The coordinates of the different structures
    are read in as needed by getTimeStep()  **/

class AMFIO_API MolTrajectoryAMF : public MolTrajectory 
{
...
protected:
    ...
    McDArray<fpos_t> posObservables;
    fpos_t posCoordinates;
