...
/// @{
#ifndef IM_FILTER_MAXIMUM_3D_H
#define IM_FILTER_MAXIMUM_3D_H
...
class HXIMPROC_API ImFilterMaximum3D : public ImFilter3D {
  
  MC_HEADER( ImFilterMaximum3D);
public:
  ///Constructor
  ImFilterMaximum3D(HxEditor* editor=0);
...
/** holds the filter algorithm*/
  ...
  static ImFilter3D* createFilter(HxEditor* e) {
      return new ImFilterMaximum3D(e); }
