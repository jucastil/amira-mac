...
/// @{
#ifndef IM_FILTER_MOMENTS_3D_H
#define IM_FILTER_MOMENTS_3D_H
...
class HXIMPROC_API ImFilterMoments3D : public ImFilter3D {
  
  MC_HEADER( ImFilterMoments3D);
public:
  ///Constructor
  ImFilterMoments3D(HxEditor* editor=0);
  ...
  static ImFilter3D* createFilter(HxEditor* e) {
      return new ImFilterMoments3D(e); }
