...
/// @{
#ifndef IM_FILTER_HISTOGRAM_3D_H
#define IM_FILTER_HISTOGRAM_3D_H
...
/** Contrast limited adaptive histogram equalization. 
    Uses HxCLAHE3D. */
class HXIMPROC_API ImFilterHistogram3D : public ImFilter3D
{
    MC_HEADER( ImFilterHistogram3D);

  public:
    /// Constructor.
    ImFilterHistogram3D(HxEditor* editor=0);
    ...
    int getClipLimit() { return (int)portClipLimit.getValue(); }
    ...
    static ImFilter3D* createFilter(HxEditor* e) {
        return new ImFilterHistogram3D(e); }
};
#endif
