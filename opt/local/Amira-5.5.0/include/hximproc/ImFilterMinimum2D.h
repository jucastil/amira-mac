...
/// @{
#ifndef IM_FILTER_MINIMUM_2D_H
#define IM_FILTER_MINIMUM_2D_H
...
class HXIMPROC_API ImFilterMinimum2D : public ImFilter2D {
  
  MC_HEADER( ImFilterMinimum2D);
public:
  ///Constructor
  ImFilterMinimum2D(HxEditor* editor=0);
...
/** holds the filter algorithm */
  ...
  Neighbourhood* getNeighbourhood() const {
      return neighbourhood[portNeighbourhood.getValue()]; }
  ...
  static ImFilter3D* createFilter(HxEditor* e) {
      return new ImFilterMinimum2D(e); }
