...
/// @{
#ifndef IM_UNSHARP_MASKING2D_H
#define IM_UNSHARP_MASKING2D_H
...
class ImSepConvFilter2D;

class HXIMPROC_API ImUnsharpMasking2D : public ImFilter2D {

  MC_HEADER(ImUnsharpMasking2D);

public:
  ///Constructor
  ImUnsharpMasking2D(HxEditor* editor=0);
  ...
  void calculateKernel(ImSepConvFilter2D *gauss, float sigma, int size);
  ...
  static ImFilter3D* createFilter(HxEditor* e) {
      return new ImUnsharpMasking2D(e); }
};
