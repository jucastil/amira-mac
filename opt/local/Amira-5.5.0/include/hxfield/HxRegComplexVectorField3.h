...
/// @{
#ifndef HX_REGULAR_COMPLEX_VECTORFIELD3
#define HX_REGULAR_COMPLEX_VECTORFIELD3

#include <hxfield/HxLattice3.h>
#include <hxfield/HxComplexVectorField3.h>

/// Represents a complex vector field defined on a regular lattice.

class HXFIELD_API HxRegComplexVectorField3 : public HxComplexVectorField3
{
  HX_DATA_HEADER(HxRegComplexVectorField3);

  public:
    /// Creates a regular complex vector field.
    static HxRegComplexVectorField3* create(const int dims[3],
	McPrimType pType, HxCoordType cType, void* data = 0);

    /// Constructor.
    HxRegComplexVectorField3(const int dims[3], McPrimType pType,
	HxCoordType cType, void* data=0);

    /// This constructor uses an existing lattice object.
    HxRegComplexVectorField3(HxLattice3* existingLattice);

    /// Destructor.
    ~HxRegComplexVectorField3();
    ...
    /// Duplicates the current HxRegComplexVectorField3 object
  ...
  protected:
    ...
    void copyData(const HxRegComplexVectorField3 &source);
