...
/// @{
#ifndef HX_TETRA_COMPLEX_SCALAR_FIELD3_H
#define HX_TETRA_COMPLEX_SCALAR_FIELD3_H
...
class HXFIELD_API HxTetraComplexScalarField3 : public HxComplexScalarField3
{
  HX_DATA_HEADER(HxTetraComplexScalarField3);

  public:
    /// Constructor.
    HxTetraComplexScalarField3(HxTetraGrid* grid,
	HxTetraData::Encoding encoding, float* data = 0);

    /// This constructor takes an existing hexa field struct.
    HxTetraComplexScalarField3(HxTetraData* existingTetraField);
    ...
    /// Duplicates the current HxTetraComplexScalarField3 object
  ...
  protected:
    void copyData(const HxTetraComplexScalarField3 &source);
