...
/// @{
#ifndef HX_HEXA_OTHER_FIELD3_H
#define HX_HEXA_OTHER_FIELD3_H
...
class HXFIELD_API HxHexaField3 : public HxField3
{
  HX_DATA_HEADER(HxHexaField3);

  public:
    /// Constructor.
    HxHexaField3(HxHexaGrid* grid, int nDataVar,
	HxHexaData::Encoding encoding, float* data = 0);

    /// This constructor takes an existing hexa field struct.
    HxHexaField3(HxHexaData* existingHexaField);
    ...
    /// Duplicates the current HxHexaField3 object
  ...
  protected:
    void copyData(const HxHexaField3 &source);
