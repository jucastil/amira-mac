...
/// @{
#ifndef HX_REGULAR_COMPLEX_SCALARFIELD3
#define HX_REGULAR_COMPLEX_SCALARFIELD3

#include <hxfield/HxLattice3.h>
#include <hxfield/HxComplexScalarField3.h>

/// Represents a complex scalar field defined on a regular lattice.

class HXFIELD_API HxRegComplexScalarField3 : public HxComplexScalarField3
{
  HX_DATA_HEADER(HxRegComplexScalarField3);

  public:
    /// Creates a regular complex scalar field.
    static HxRegComplexScalarField3* create(const int dims[3],
	McPrimType pType, HxCoordType cType, void* data = 0);

    /// Constructor.
    HxRegComplexScalarField3(const int dims[3], McPrimType pType,
	HxCoordType cType, void* data=0);

    /// This constructor uses an existing lattice object.
    HxRegComplexScalarField3(HxLattice3* existingLattice);
    ...
    /// Duplicates the current HxRegComplexScalarField3 object
  ...
  protected:
    ...
    void copyData(const HxRegComplexScalarField3 &source);
