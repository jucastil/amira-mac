...
/// @{
#ifndef HX_TETRA_SYM2TENSOR_FIELD3_H
#define HX_TETRA_SYM2TENSOR_FIELD3_H
...
/// Represents a symmetric second order tenosr field on a tetrahedral grid.

class HXFIELD_API HxTetraSym2TensorField3 : public HxSym2TensorField3
{
  HX_DATA_HEADER(HxTetraSym2TensorField3);

  public:
    /// Constructor.
    HxTetraSym2TensorField3(HxTetraGrid* grid,
    HxTetraData::Encoding encoding, float* data = 0);

    /// This constructor takes an existing tetrahedral field struct.
    HxTetraSym2TensorField3(HxTetraData* existingTetraField);

    /// Destructor.
    ~HxTetraSym2TensorField3();
    ...
    /// Duplicates the current HxTetraSym2TensorField3 object
  ...
  protected:
    void copyData(const HxTetraSym2TensorField3 &source);
