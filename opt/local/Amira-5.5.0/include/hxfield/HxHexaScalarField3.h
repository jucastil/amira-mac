...
/// @{
#ifndef HX_HEXA_SCALAR_FIELD3_H
#define HX_HEXA_SCALAR_FIELD3_H
...
class HXFIELD_API HxHexaScalarField3 : public HxScalarField3
{
  HX_DATA_HEADER(HxHexaScalarField3);

  public:
    /// Specifies how the field is defined
    enum Encoding {
        PER_VERTEX=HxHexaData::PER_VERTEX,
        PER_HEXA_VERTEX=HxHexaData::PER_HEXA_VERTEX,
        PER_HEXA=HxHexaData::PER_HEXA };

    /// Constructor.
    HxHexaScalarField3(HxHexaGrid* grid,
	HxHexaData::Encoding encoding, float* data = 0);

    /// This constructor takes an existing hexa field struct.
    HxHexaScalarField3(HxHexaData* existingHexaField);
    ...
    /// Duplicates the current HxHexaScalarField3 object
  ...
  protected:
    void copyData(const HxHexaScalarField3 &source);
