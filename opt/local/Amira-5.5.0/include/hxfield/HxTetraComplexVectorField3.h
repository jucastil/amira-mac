...
/// @{
#ifndef HX_TETRA_COMPLEX_VECTOR_FIELD3_H
#define HX_TETRA_COMPLEX_VECTOR_FIELD3_H
...
class HXFIELD_API HxTetraComplexVectorField3 : public HxComplexVectorField3
{
  HX_DATA_HEADER(HxTetraComplexVectorField3);

  public:
    /// Constructor.
    HxTetraComplexVectorField3(HxTetraGrid* grid,
	HxTetraData::Encoding encoding, float* data = 0);

    /// This constructor takes an existing hexa field struct.
    HxTetraComplexVectorField3(HxTetraData* existingTetraField);

    /// Destructor.
    ~HxTetraComplexVectorField3();
    ...
    /// Duplicates the current HxTetraComplexVectorField3 object
  ...
  protected:
    void copyData(const HxTetraComplexVectorField3 &source);
