...
/// Represents a general location with a uniform grid.

class HXFIELD_API HxLoc3Uniform : public HxLoc3Regular
{
  public:
    /// Sets location within uniform grid.
  ...
  protected:
    /// This class should only be created by a HxUniformCoord3.
    HxLoc3Uniform(HxUniformCoord3* coords);
