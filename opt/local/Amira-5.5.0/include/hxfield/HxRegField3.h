...
/// Represents an n-valued field defined on a regular lattice.

class HXFIELD_API HxRegField3 : public HxField3
{
  HX_DATA_HEADER(HxRegField3);

  public:
    /// Creates a regular vector field.
    HxRegField3(int nDataVar, const int dims[3], McPrimType
	primType, HxCoordType coordType);

    /// This constructor uses an existing lattice object.
    HxRegField3(HxLattice3* existingLattice);
  ...
  protected:
    ...
    void copyData(const HxRegField3 &source);
