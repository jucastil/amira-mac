...
/// @{
#ifndef HX_HEXA_COMPLEX_SCALAR_FIELD3_H
#define HX_HEXA_COMPLEX_SCALAR_FIELD3_H
...
class HXFIELD_API HxHexaComplexScalarField3 : public HxComplexScalarField3
{
  HX_DATA_HEADER(HxHexaComplexScalarField3);

  public:

    /// Constructor.
    HxHexaComplexScalarField3(HxHexaGrid* grid,
	HxHexaData::Encoding encoding, float* data = 0);

    /// This constructor takes an existing hexa field struct.
    HxHexaComplexScalarField3(HxHexaData* existingHexaField);
    ...
    /// Duplicates the current HxHexaComplexScalarField3 object
  ...
  protected:
    ...
    void copyData(const HxHexaComplexScalarField3 &source);
