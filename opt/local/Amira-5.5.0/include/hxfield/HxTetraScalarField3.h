...
/// @{
#ifndef HX_TETRA_SCALAR_FIELD3_H
#define HX_TETRA_SCALAR_FIELD3_H
...
/// Represents a scalar field on a tetrahedral grid.

class HXFIELD_API HxTetraScalarField3 : public HxScalarField3
{
  HX_DATA_HEADER(HxTetraScalarField3);

  public:
    /// Specifies how the field is defined
    enum Encoding {
        PER_VERTEX=HxTetraData::PER_VERTEX,
        PER_TETRA_VERTEX=HxTetraData::PER_TETRA_VERTEX,
        PER_TETRA=HxTetraData::PER_TETRA };

    /// Constructor.
    HxTetraScalarField3(HxTetraGrid* grid,
	HxTetraData::Encoding encoding=HxTetraData::PER_VERTEX, float* data=0);

    /// This constructor takes an existing hexa field struct.
    HxTetraScalarField3(HxTetraData* existingTetraField);
    ...
    /// Duplicates the current HxTetraScalarField3 object
    ...
    */
    ...
    Encoding encoding() const { return (Encoding) data.encoding(); }
  ...
  protected:
    void copyData(const HxTetraScalarField3 &source);
