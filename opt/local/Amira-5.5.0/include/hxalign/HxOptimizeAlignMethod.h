...
/// @{
#ifndef HX_OPTIMIZE_ALIGN_METHOD
#define HX_OPTIMIZE_ALIGN_METHOD
...
class HxOptimizeAlignMethod : public HxAutoAlignMethod
{
...
public:
     ...
     */
    HxOptimizeAlignMethod(HxAlignSlices* parent);

    /** Destructor */
    virtual ~HxOptimizeAlignMethod(){};

    /// returns the method name
    static const char* getMethodName();

    /// creates a new alignMethod
