...
/// @{
#ifndef HX_CENTER_ALIGN_METHOD
#define HX_CENTER_ALIGN_METHOD
...
class HxCenterAlignMethod : public HxAutoAlignMethod
{
...
public:
     ...
     */
    HxCenterAlignMethod(HxAlignSlices* parent);

    /** Destructor */
    virtual ~HxCenterAlignMethod(){};
