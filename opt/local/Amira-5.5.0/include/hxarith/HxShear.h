...
class HXARITH_API HxShear : public HxCompModule {
  ...
  public:
    ...
    /// Label for amount of vectors
    HxPortFloatTextN  portAngle;

    /// Background value
    HxPortIntTextN  portBackground;
  ...
  protected:
    ...
    void initialize (HxLattice3 *, float = 0);

    // user defined shear angle
    float _angle;
    ...
    // maximum slice shift in voxels
    int _yInc;

    HxUniformScalarField3 * _input;
};
