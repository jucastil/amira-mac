...
class HxTetraVectorField3;

class HXARITH_API HxLambda2 : public HxCompModule {
  ...
  public:
    ...
    static void computeRegular(HxRegScalarField3* lbda2Fld, HxRegVectorField3* srcFld);

  protected:

    void computeTetra(HxTetraVectorField3* vf);
