...
/// @{
#ifndef  EX_SPATIALGRAPH_PICK_TOOL_H
#define  EX_SPATIALGRAPH_PICK_TOOL_H
...
*/
class ExSpatialGraphPickTool : public ExShapeTool
{
public:

    ExSpatialGraphPickTool();
    
    void setEditor(HxNeuronEditorSubApp *editor);
