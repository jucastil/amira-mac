...
/// @{
#ifndef UNDOREDOTOOL_H
#define UNDOREDOTOOL_H 
...
class UndoTool : public HxViewerTriggerTool {
public:
    UndoTool(HxNeuronEditorSubApp *editor); 
...
class RedoTool : public HxViewerTriggerTool {
public:
    RedoTool(HxNeuronEditorSubApp *editor);
    virtual bool supportsViewer(HxViewerBase* baseViewer);
    virtual void onTrigger(HxViewerBase* activeViewer, int modifiers) {};
private:
    HxNeuronEditorSubApp *mEditor;
