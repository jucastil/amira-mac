...
/// @{
#ifndef EX_NOTIFIER_H
#define EX_NOTIFIER_H
...
class ExNotifier : public ExNotifiable
{
  public:

    ExNotifier(HxNeuronEditorSubApp *editor);
    ~ExNotifier();
...
//////////////////////////////////////////////////////////////////////////////////////
class VsNotifier : public VsObject
{
  public:

    VsNotifier(HxNeuronEditorSubApp *editor);
    ~VsNotifier();
