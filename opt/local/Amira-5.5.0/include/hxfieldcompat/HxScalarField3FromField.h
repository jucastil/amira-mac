...
/// @{
#ifndef HX_FIELD_COMPAT_HX_SCALAR_FIELD_3_FROM_FIELD_H
#define HX_FIELD_COMPAT_HX_SCALAR_FIELD_3_FROM_FIELD_H
...
/**
    ...
    and the world of HxField3 (HxScalarField3, etc.). Many of the currently existing
    visualization modules can not jet natively deal with HxField fields. Therefore,
    this class can wrap a HxField-Field, and expose it as HxScalarField3.
*/
class HXFIELDCOMPAT_API HxScalarField3FromField : public HxScalarField3 
{
    HX_HEADER(HxScalarField3FromField);
public:
    HxScalarField3FromField();
...
protected:
    ...
    */
    ...
    static int eval(HxScalarField3FromField*, HxLocation3FromEvaluator*, float*);

    virtual void getBoundingBox(float bbox[6]) const;

    virtual void getRange(float &min, float &max, HxScalarField3::RangeType rangeType=HxScalarField3::RAW_DATA);
