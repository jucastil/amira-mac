...
// what a ugly hack. 
// On OS X we want to use the system lib
// But we have a lot of symbol with explizit prefix 
// therefore, we include the system lib define
// all our prefixed symbols to go away...
// -- SteffenProhaska Fri Feb 20 22:14:14 CET 2004
#ifdef HX_OS_MACX

// Use the system lib 
#  include </usr/include/zlib.h>

// define _ZLIB_H like in ZLIB 1.x
#  ifdef ZLIB_H
#    define _ZLIB_H
#  endif

// and remove all prefixes from all our symbols
