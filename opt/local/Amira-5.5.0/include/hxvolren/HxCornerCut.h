...
/// @{
#ifndef HX_CORNER_CUT_H
#define HX_CORNER_CUT_H
...
#include <hxvolren/hxvolrenAPI.h>

#include <vsvolren/VsCornerCut.h>
#include <vsvolren/VsBoundingBox.h>

///
class HXVOLREN_API HxCornerCut
:   public HxCompModule
{
    HX_HEADER(HxCornerCut);
...
public:
    ...
    ///
    HxPortRadioBox portOctant;

    /// 
    HxPortFloatSlider portX;

    ///
    HxPortFloatSlider portY;

    ///
    HxPortFloatSlider portZ;
...
protected:
    ...
    McHandle<SoCallback> mCallback;
    McHandle<VsCornerCut> mCornerCut;
