...
class HXVSDATA_API HxVsData : public HxSpatialData {
  ...
  public:
    ...
    void setVolume(VsVolume* volume);

    static int readAmiraMesh(AmiraMesh* m, const char *filename);

    static int writeAmiraMesh(HxVsData* d, const char *filename);

    static int writeStandardAmiraMesh(HxVsData* d, const char *filename);
    ...
    VsData* labelData() const { return mVolume ? mVolume->labelData(0) : 0; }
