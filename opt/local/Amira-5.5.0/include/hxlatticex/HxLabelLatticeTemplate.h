...
/// @{
#ifndef HX_LABEL_LATTICE_TEMPLATE_H
#define HX_LABEL_LATTICE_TEMPLATE_H

#include "HxLattice.h"
#include "HxLabelLattice.h"

template <class PROXY>
class HxLabelLatticeProxyTemplate : public HxLabelLattice {
    MC_TEMPLATE_HEADER (HxLabelLatticeProxyTemplate<PROXY>);
    public:
        HxLabelLatticeProxyTemplate (McInterfaceOwner* owner, PROXY* p) 
            : HxLabelLattice (owner)
            , mProxy(p) {}

        HxLabelLatticeProxyTemplate (McInterface* iface, PROXY* p) 
            : HxLabelLattice (static_cast<McInterfaceOwner*>(iface->getInterface (McInterfaceOwner::getClassTypeId())))
            , mProxy(p) {}
