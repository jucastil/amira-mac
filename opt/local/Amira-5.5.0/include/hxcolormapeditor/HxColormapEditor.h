...
/// @{
#ifndef HX_COLORMAP_EDITOR
#define HX_COLORMAP_EDITOR

#include <hxcore/HxEditor.h>
#include <hxcolormapeditor/HxColormapEditorWinDLLApi.h>

class QxColormapEditor;
class QxEditorNotifier;

/// HxColormapEditor

class HXCOLORMAPEDITOR_API HxColormapEditor : public HxEditor {

  HX_HEADER(HxColormapEditor);
  ...
  protected:
    /// Destructor
    virtual ~HxColormapEditor();

    virtual void startEditing( HxData * data );
    virtual void stopEditing();

    QxColormapEditor* editor;
