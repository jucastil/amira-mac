...
/// @{
#ifndef ATOMTYPER_MOL2_H
#define ATOMTYPER_MOL2_H
...
namespace molchem {
    /** \brief AtomTyper for the mol2 types. 

    Computes mol2 atom types. The list of possible atom types
    is loaded from the file given in molchem::Resource::atomTypeMol2TableFilename
    
    \section references References:

    - SYBYL Mol2 AtomTypes: http://www.tripos.com/mol2/atom_types.html
    */
    class MOLCHEM_API AtomTyper_Mol2 : public molchem::AtomTyper {
    public:
        AtomTyper_Mol2();
        virtual ~AtomTyper_Mol2() {}
        /** Computes atoms types

            \param[in] mol Molecule whose atoms will be processed. Must contain
                bond orders and correct number of implicit hydrogens and formal charges
