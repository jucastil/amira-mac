...
/// @{
#ifndef __AMIRA_HxTimeRotate_H_
#define __AMIRA_HxTimeRotate_H_
 ...
 */
class HxTimeRotate : public HxModule
{
	HX_HEADER(HxTimeRotate); 

	SbVec3f 	pos;
	SbRotation 	rot; 
		
public:
	HxPortFloatSlider	portAngularVelocity; 
...
protected:
	...
	virtual ~HxTimeRotate();

	void info();	
};

#endif /* __AMIRA_HxTimeRotate_H_ */
