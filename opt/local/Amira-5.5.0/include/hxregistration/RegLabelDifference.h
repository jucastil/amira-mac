...
/// @{
#ifndef REG_LABELDIFFERENCE
#define REG_LABELDIFFERENCE

#include <hxregistration/RegMeanSquaredDifference.h>
#include <hxfield/HxLoc3Regular.h>
#include <hxfield/HxCoord3.h>

/// similarity measure.
class HXREGISTRATION_API RegLabelDifference : public RegMeanSquaredDifference
{
    public:
   /** Constructor.
    ...
    */
    RegLabelDifference (double maxCov = 1.);

    //Copy Constructor fehlt!!
...
protected:
	RegLabelDifference (mclong s, mclong sT, double maxCov, double sum): 
	RegMeanSquaredDifference(s, sT, maxCov, sum) {}
