...
/// @{
#ifndef HX_LANDMARK_SURFACE_WARP
#define HX_LANDMARK_SURFACE_WARP
...
class HxVertexSet;
/** ... */
class HXWARP_API HxLandmarkSurfaceWarp : public HxCompModule {

  HX_HEADER(HxLandmarkSurfaceWarp);
  
  public:
    /** Constructor. */
    HxLandmarkSurfaceWarp();
    ...
    /** Filter types: 0=Bookstein-Splines 1=flow.. */
    HxPortMultiMenu portMethod;

    /** Linear transformation type (0=rigid, 1=rigid+uniform scale, 2=affine) */
    HxPortRadioBox portTrafoType;
