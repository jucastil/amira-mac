...
/// @{
#ifndef MOLECULE_BUNDLE_MEM_H
#define MOLECULE_BUNDLE_MEM_H

#include "MoleculeWinDLLApi.h"
#include "MoleculeBundle.h"
template <class T> class McDArray;
/** A MoleculeBundleMem contains a set of molecules in memory.
 */

class MOLECULE_API MoleculeBundleMem : public MoleculeBundle
{

public:
    MoleculeBundleMem();

    virtual ~MoleculeBundleMem();
    ...
    virtual void addMolecule(Molecule* mol);
protected:
    McDArray<Molecule*>* bundle;
};
