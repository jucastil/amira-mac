...
class HXTRACKING_API Hx3DText : public Qx3DWidget
{
  public:
    Hx3DText(Qx3DWidget* parent, HxObject* object);
    ...
    static void show3DText(const char* text, HxObject* object);

    static void hide3DText(HxObject* object);

    static void free3DText(HxObject* object);
