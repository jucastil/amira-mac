...
/// @{
#ifndef MOL_TRAJECTORYGROMACS_SINGLE_H
#define MOL_TRAJECTORYGROMACS_SINGLE_H

#include "MolIOWinDLLApi.h"
#include <molecule/MolTrajectory.h>
#include <molio/GROMACSread_SINGLE.h>
#include <mclib/McDArray.h>
#include <mclib/McString.h>

class TrnHeader_SINGLE; 
/**
...
class MOLIO_API MolTrajectoryGROMACS_SINGLE : public MolTrajectory 
{
protected:    
...
public: 
    ...
    McHandle<TrnHeader_SINGLE> header;

    /// main constructor
    MolTrajectoryGROMACS_SINGLE(Molecule * mol, const McString & trajfileName);

    /// Destructor
    ~MolTrajectoryGROMACS_SINGLE();    
