...
/// @{
#ifndef MOL_TRAJECTORYAMBER_H
#define MOL_TRAJECTORYAMBER_H

#include "MolIOWinDLLApi.h"
#include <molecule/MolTrajectory.h>
#include <molio/AMBERread.h>
#include <mclib/McDArray.h>
#include <mclib/McString.h>

/**
 * class reading a molecular trajectory from Amber files.
 */

class Molecule;

class MOLIO_API MolTrajectoryAMBER : public MolTrajectory 
{
protected:    
    ...
    McString trajfilename;
        ...
        /// saves the streamposition of the velocities for each timestep - currently not used
    McDArray<long> velstreamPos;

    /// name of the file, the velocities are saved in - currently not used
    McString velfilename;    
...
public: 
    ...
    /// main constructor
    MolTrajectoryAMBER(MolTopology* T,const McString & trajfileName,const McString & velfileName,const  McString & mainf);    
