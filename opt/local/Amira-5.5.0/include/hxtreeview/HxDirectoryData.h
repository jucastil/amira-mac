...
/// @{
#ifndef HX_DIRECTORY_DATA
#define HX_DIRECTORY_DATA
...
class HXTREEVIEW_API HxDirectoryData : public HxDirectory
{
...
public:
    ...
    /// Constructors.
    HxDirectoryData();
    HxDirectoryData(const char* dirLabel, const char* parentDir);

    /// Destructor is virtual.
    virtual ~HxDirectoryData();
