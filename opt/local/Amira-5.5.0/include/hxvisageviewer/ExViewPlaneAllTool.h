...
/// @{
#ifndef  EX_VIEWPLANEALLTOOL_H
#define  EX_VIEWPLANEALLTOOL_H

#include "ExTrigger.h"


class ExViewPlaneAllTool : public ExTrigger
{
public:
    ...
    ////////////////////////////////////////
    // virtual override methods of ExTrigger
    ////////////////////////////////////////

    virtual bool process(ExBaseViewer* viewer, bool set);
};

#endif // EX_VIEWPLANEALLTOOL_H
