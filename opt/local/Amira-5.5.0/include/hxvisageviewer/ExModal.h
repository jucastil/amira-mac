...
/** Tools that are active until another tool is chosen. They change 
    the kind of mouse interaction in empty regions of the viewer. */
class HXVISAGEVIEWER_API ExModal : public ExTool {
public:
    
    ExModal(int /* Vs::ButtonState */ activeState = 0, bool exclusive = false);
    ...
    int stateForUse() const;

protected:
    int  mButtonStateForUse;
    bool mExclusive;
};
