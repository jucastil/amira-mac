...
/**
  * This functions gathers and stores some system informatoins into the given string.
  */
...
/**
  ...
  * version string inseide the file gets replaced. Additionally this function computes
...
/**
  * returns the value for the specified tag or null if the tag was not found.
  */
const char* versionGetTag( McDArray<McString> & inVersionArray, const char* inTag );
