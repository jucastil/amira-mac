...
class HxVisageViewerMaterialListItem : public QObject
{
    Q_OBJECT

public:
    HxVisageViewerMaterialListItem(HxVisageViewerMaterialList* tl, HxParamBundle* mat, int row);
...
private slots:
    ...
    void slotalphaSlider(int value);

private:
    HxVisageViewerMaterialList* tissuelist;
