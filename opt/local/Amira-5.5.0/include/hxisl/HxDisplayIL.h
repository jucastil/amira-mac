...
/// @{
#ifndef HX_DISPLAY_IL_H
#define HX_DISPLAY_IL_H
...
/// Displays a line set with an illumination effect.
class HXISL_API HxDisplayIL : public HxModule {

  HX_HEADER(HxDisplayIL);
  ...
  protected:
    ...
    McHandle<SoIllumLines> scene;
    McHandle<SoElapsedTime> elapsedTime;

    void mapColorValues(HxLineSetInterface* lineSet);

    void buildSceneGraph(HxLineSetInterface* lineSet);

    void savePorts(FILE* fp);

  private:

    HxLineSetInterface* myLineSet;
};
