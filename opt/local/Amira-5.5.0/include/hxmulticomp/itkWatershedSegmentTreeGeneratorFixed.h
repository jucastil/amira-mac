...
=========================================================================*/
#ifndef __itkWatershedSegmentTreeGeneratorFixed_h
#define __itkWatershedSegmentTreeGeneratorFixed_h
...
class ITK_EXPORT SegmentTreeGeneratorFixed  : public ProcessObject
{
public:
  /**  Standard itk smart pointer declarations    */
  typedef SegmentTreeGeneratorFixed     Self;
  typedef ProcessObject            Superclass;
  typedef SmartPointer<Self>       Pointer;
  typedef SmartPointer<const Self> ConstPointer;
  itkNewMacro(Self);
  itkTypeMacro(WatershedSegmentTreeGeneratorFixed, ProcessObject);
...
protected:
  SegmentTreeGeneratorFixed();
  virtual ~SegmentTreeGeneratorFixed() {}
  SegmentTreeGeneratorFixed(const Self&) {}
...
#include "itkWatershedSegmentTreeGeneratorFixed.txx"
#endif
