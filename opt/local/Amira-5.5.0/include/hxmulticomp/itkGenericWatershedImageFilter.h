...
=========================================================================*/
#ifndef __itGenericWatershedImageFilter_h
#define __itGenericWatershedImageFilter_h
...
#include "itkWatershedSegmentTreeGeneratorFixed.h"
#include "itkAscendingOrderWatershedRelabeler.h"
...
class ITK_EXPORT GenericWatershedImageFilter :
    public ImageToImageFilter< TInputImage, TOutputImage>
{
public:
  /** Standard "Self" typedef.   */
  typedef GenericWatershedImageFilter Self;
  ...
  itkTypeMacro(GenericWatershedImageFilter, ImageToImageFilter);
  ...
  typename watershed::SegmentTreeGeneratorFixed<ScalarType>::SegmentTreeType *
  GetSegmentTree()
    {
...
protected:
  GenericWatershedImageFilter();
  virtual ~GenericWatershedImageFilter() {}
  GenericWatershedImageFilter(const Self&) {}
...
private:
  ...
  typename watershed::SegmentTreeGeneratorFixed<ScalarType>::Pointer m_TreeGenerator;
  typename watershed::AscendingOrderRelabeler<ScalarType, OutputScalarType, itkGetStaticConstMacro(ImageDimension)>::Pointer
                                                                m_Relabeler;
...
#include "itkGenericWatershedImageFilter.txx"
#endif
