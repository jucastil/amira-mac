...
=========================================================================*/
#ifndef __itkAscendingOrderWatershedRelabeler_h
#define __itkAscendingOrderWatershedRelabeler_h
...
template <class TScalarType, class TOutputScalarType, unsigned int TImageDimension>
class ITK_EXPORT AscendingOrderRelabeler
  : public ProcessObject
{
public:
  /** Define smart pointers for this object */
  typedef AscendingOrderRelabeler  Self;
  typedef ProcessObject            Superclass;
  typedef SmartPointer<Self>       Pointer;
  typedef SmartPointer<const Self> ConstPointer;
  itkNewMacro(Self);
  itkTypeMacro(AscendingOrderWatershedRelabeler, ProcessObject);
  ...
  typedef Image<unsigned long, TImageDimension>          InputImageType;
  typedef Image<TOutputScalarType, TImageDimension>      OutputImageType;
  ...
  void GraftOutput(OutputImageType *graft);
  void GraftNthOutput(unsigned int idx, OutputImageType *graft);
  
protected:
  AscendingOrderRelabeler();
  virtual ~AscendingOrderRelabeler() {}
  AscendingOrderRelabeler(const Self&) {}
...
#include "itkAscendingOrderWatershedRelabeler.txx"
#endif
