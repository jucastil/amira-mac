...
/// @{
#ifndef HXSURFTOOLS_HXVIEWBASEEXTRACT_H
#define HXSURFTOOLS_HXVIEWBASEEXTRACT_H
...
/** Module to extract and merge surfaces from different instances of HxViewBase.

@author Tino Weinkauf
*/
class HXSURFTOOLS_API HxViewBaseExtract : public HxCompModule
{
	HX_HEADER(HxViewBaseExtract);
...
public:
	...
	HxSurface* CreateOrReuseResult(const bool bEmptyFirst);

	///Clears the result surface, if existing.
	void ClearResult();
...
public:
	...
	McDArray< HxConnection* > connViewBases;
...
#endif //HXSURFTOOLS_HXVIEWBASEEXTRACT_H
