...
/// @{
#ifndef HX_CREATESPHERE_H
#define HX_CREATESPHERE_H
 ...
 */
class HXSURFTOOLS_API HxCreateSphere : public HxCompModule {

    HX_HEADER(HxCreateSphere);
...
public:
    ...
    /// Number of surface points per unit^2.
    HxPortFloatSlider portNOPPerUnit2;
...
protected:
    ...
    void triangulateMolSphere();
    void triangulateOctahedronSphere();
};
