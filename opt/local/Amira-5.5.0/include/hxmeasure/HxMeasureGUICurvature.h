...
#ifndef HX_MEASURE_GUI_CURVATURE
#define HX_MEASURE_GUI_CURVATURE
...
/** A collection of 3 points that are interpreted as an angle.
  */
class HXMEASURE_API HxMeasureGUICurvature : public HxMeasureGUIFrame {
    public:
        ///
        HxMeasureGUICurvature ();

        /// redraw with openGL
        virtual void redraw (); 

        /// handle an Inventor event.
        virtual int handleEvent (const SoEvent* event);
