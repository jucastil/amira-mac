...
/// @{
#ifndef HX_MEASURE_GUI_ANNOTATION
#define HX_MEASURE_GUI_ANNOTATION

#include <hxmeasure/HxMeasureWinDLLApi.h>
#include <hxmeasure/HxMeasureGUIFrame.h>

/** A single point with a comment. */
class HXMEASURE_API HxMeasureGUIAnnotation : public HxMeasureGUIFrame
{
    public:
        ///
        HxMeasureGUIAnnotation(Mode m);
