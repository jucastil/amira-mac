...
/// @{
#ifndef HX_SURFACE_AREA
#define HX_SURFACE_AREA
...
class HXSTATISTICS_API HxSurfaceArea : public HxCompModule
{
  HX_HEADER(HxSurfaceArea);

  public:
    /// Default constructor.
    HxSurfaceArea();

    /// Mode: 0=regions, 1=patches
