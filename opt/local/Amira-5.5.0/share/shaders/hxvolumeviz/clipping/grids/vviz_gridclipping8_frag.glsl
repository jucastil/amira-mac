...
// Grid4 parameters
uniform sampler2D VVizClipMap4;
uniform float VVizZScale4;
uniform float VVizClipThickness4;
uniform int VVizClipBelowMode4;
uniform int VVizClipAboveMode4;
uniform int VVizClipRevertMode4;
varying vec3 VVizPlanDist4;

// Grid5 parameters
uniform sampler2D VVizClipMap5;
uniform float VVizZScale5;
uniform float VVizClipThickness5;
uniform int VVizClipBelowMode5;
uniform int VVizClipAboveMode5;
uniform int VVizClipRevertMode5;
varying vec3 VVizPlanDist5;

// Grid6 parameters
uniform sampler2D VVizClipMap6;
uniform float VVizZScale6;
uniform float VVizClipThickness6;
uniform int VVizClipBelowMode6;
uniform int VVizClipAboveMode6;
uniform int VVizClipRevertMode6;
varying vec3 VVizPlanDist6;

// Grid7 parameters
uniform sampler2D VVizClipMap7;
uniform float VVizZScale7;
uniform float VVizClipThickness7;
uniform int VVizClipBelowMode7;
uniform int VVizClipAboveMode7;
uniform int VVizClipRevertMode7;
...
void VVizClipVolumeGrid()
{
  ...
  if (VVizIsInNormalizedRange(VVizPlanDist4.xy))
  {
    // NOTHING
  }
  else
  ...
  if (VVizIsInNormalizedRange(VVizPlanDist5.xy))
  {
    // NOTHING
  }
  else
  ...
  if (VVizIsInNormalizedRange(VVizPlanDist6.xy))
  {
    // NOTHING
  }
  else
  ...
  if (VVizIsInNormalizedRange(VVizPlanDist7.xy))
  {
    // NOTHING
  }
  else
  ...
  float elevation4 = VVizCheckClippingElevation(VVizPlanDist4, VVizZScale4, VVizClipMap4, VVizClipRevertMode4);
  float elevation5 = VVizCheckClippingElevation(VVizPlanDist5, VVizZScale5, VVizClipMap5, VVizClipRevertMode5);
  float elevation6 = VVizCheckClippingElevation(VVizPlanDist6, VVizZScale6, VVizClipMap6, VVizClipRevertMode6);
  float elevation7 = VVizCheckClippingElevation(VVizPlanDist7, VVizZScale7, VVizClipMap7, VVizClipRevertMode7);
  ...
  VVizClipGrid(elevation4, VVizZScale4, VVizClipAboveMode4, VVizClipBelowMode4, VVizClipThickness4);
  VVizClipGrid(elevation5, VVizZScale5, VVizClipAboveMode5, VVizClipBelowMode5, VVizClipThickness5);
  VVizClipGrid(elevation6, VVizZScale6, VVizClipAboveMode6, VVizClipBelowMode6, VVizClipThickness6);
  VVizClipGrid(elevation7, VVizZScale7, VVizClipAboveMode7, VVizClipBelowMode7, VVizClipThickness7);
}
