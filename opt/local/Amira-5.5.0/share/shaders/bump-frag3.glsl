...
vec3 computeNormal()
{
  ...
  u00.z = getData(data3, newTexCoord);
  if(u00.x > epsilon0 && u00.y > epsilon0 && u00.z > epsilon0 && u00.x < epsilon1 && u00.y < epsilon1 && u00.z < epsilon1) {
    ...
    u01.z = getData(data3, newTexCoord + vec2(0.0, 1./dimTextureV));
    if(u01.x > epsilon0 && u01.y > epsilon0 && u01.z > epsilon0 && u01.x < epsilon1 && u01.y < epsilon1 && u01.z < epsilon1) {
      ...
      u10.z = getData(data3, newTexCoord + vec2(1./dimTextureU, 0.0));
      if(u10.x > epsilon0 && u10.y > epsilon0 && u10.z > epsilon0 && u10.x < epsilon1 && u10.y < epsilon1 && u10.z < epsilon1) {
	float Ha, Hg, Hr;
	Hg = length(u00);
	Ha = length(u01);
