# Amira Script
if { [ exists lobus.gmc-surf ] } { lobus.gmc-surf hideIcon }
remove -all
...
if { ![ exists lobus.gmc-surf ] } {
    ...
    set hideNewModules 0
    load ${AMIRA_ROOT}/data/tutorials/lobus.labels.am
    ...
    set hideNewModules 0
    [ {GMC} create {lobus.gmc-surf} ] setLabel {lobus.gmc-surf}
    ...
    {lobus.gmc-surf} showIcon
    {lobus.gmc-surf} setIconPosition 20 100
}

{lobus.gmc-surf} select
...
Simplifier attach {lobus.gmc-surf}
Simplifier simplifyParameters setValue 0 8000
Simplifier simplifyOptions setValue 0 0
Simplifier simplifyOptions setValue 1 1
Simplifier smooth 10 0.6
Simplifier simplifyAction setIndex 0
Simplifier fire
{lobus.gmc-surf} setLabel lobus.simplified
