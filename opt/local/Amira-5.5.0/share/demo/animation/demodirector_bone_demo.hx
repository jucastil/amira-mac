# Amira Script
remove -all
remove temperature.icol reg005.ctdata.am reg005.surf BoundingBox OrthoSlice DemoMaker SurfaceView
...
{DemoMaker} setVar {internalEventList} {dummy {numeric {{OrthoSlice/Slice Number} 102} 0 15 0 30 -1e24 1e24 {OrthoSlice sliceNumber setValue %0%; OrthoSlice fire}} {toggle {{SurfaceView/Viewer mask/Viewer 0} 105} 15 1 {SurfaceView setViewerMask [expr ([SurfaceView getViewerMask]&254)+%0%*1]}}}
{DemoMaker} setVar {lastStartTime} {15}
{DemoMaker} setVar {lastEndTime} {15}
{DemoMaker} setVar {lastTimeStep} {0}
{DemoMaker} setVar {eventIdCount} {106}
{DemoMaker} setVar {eventTemplateIdCount} {155}
...
DemoMaker eventList setOptValue 0 0
...
DemoMaker guiElements setOptValue 0 0
...
DemoMaker triggerTime setValue 0 15
...
DemoMaker startEndTime setValue 1 10.6389999389648
