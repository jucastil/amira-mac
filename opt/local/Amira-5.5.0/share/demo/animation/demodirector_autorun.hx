...
{DemoMaker} setVar {internalEventList} {dummy {numeric {{OrthoSlice/Slice Number} 102} 0 15 0 30 -1e24 1e24 {OrthoSlice sliceNumber setValue %0%; OrthoSlice fire}} {toggle {{SurfaceView/Viewer mask/Viewer 0} 105} 15 1 {SurfaceView setViewerMask [expr ([SurfaceView getViewerMask]&254)+%0%*1]}} {break {{Break (continue on keystroke)} 132} 16} {numeric {CameraRotate/Time 109} 20 35 0 360 -1e24 1e24 {CameraRotate time setValue %0%; CameraRotate fire}} {numeric {{OrthoSlice/Slice Number} 117} 20 35 30 3 -1e24 1e24 {OrthoSlice sliceNumber setValue %0%; OrthoSlice fire}} {numeric {CameraRotate/Time 130} 35 50 0 360 -1e24 1e24 {CameraRotate time setValue %0%; CameraRotate fire}} {numeric {{OrthoSlice/Slice Number} 127} 35 50 3 58 -1e24 1e24 {OrthoSlice sliceNumber setValue %0%; OrthoSlice fire}} {select {OrthoSlice/Transparency 123} 35 2 0 {None Binary Alpha} {OrthoSlice transparency setValue %0%; OrthoSlice fire}} {toggle {{SurfaceView2/Clip using OrthoSlice} 120} 35 1 {if %0% {SurfaceView2 clipGeom OrthoSlice} else {SurfaceView2 unclipGeom OrthoSlice}}} {toggle {{SurfaceView2/Viewer mask/Viewer 0} 112} 35 1 {SurfaceView2 setViewerMask [expr ([SurfaceView2 getViewerMask]&254)+%0%*1]}} {break {{Break (continue on keystroke)} 134} 36}}
{DemoMaker} setVar {lastStartTime} {36}
{DemoMaker} setVar {lastEndTime} {36}
{DemoMaker} setVar {lastTimeStep} {0}
{DemoMaker} setVar {eventIdCount} {135}
{DemoMaker} setVar {eventTemplateIdCount} {182}
{DemoMaker} setVar {lengthOfNewEvents} {10.5786}
...
DemoMaker guiElements setOptValue 0 2
...
DemoMaker triggerTime setValue 0 36
...
DemoMaker waitingTime setValue 0 10.5785999298096
DemoMaker gotoTime setMinMax 0 -3.40282346638529e+038 3.40282346638529e+038
DemoMaker gotoTime setValue 0 10.5785999298096
...
DemoMaker startEndTime setValue 1 10.5785999298096
