...
{DemoMaker} setVar {internalEventList} {dummy {numeric {{OrthoSlice/Slice Number} 102} 0 15 0 30 -1e24 1e24 {OrthoSlice sliceNumber setValue %0%; OrthoSlice fire}} {toggle {{SurfaceView/Viewer mask/Viewer 0} 105} 15 1 {SurfaceView setViewerMask [expr ([SurfaceView getViewerMask]&254)+%0%*1]}} {numeric {CameraRotate/Time 109} 20 35 0 360 -1e24 1e24 {CameraRotate time setValue %0%; CameraRotate fire}} {numeric {{OrthoSlice/Slice Number} 117} 20 35 30 3 -1e24 1e24 {OrthoSlice sliceNumber setValue %0%; OrthoSlice fire}} {toggle {{SurfaceView2/Viewer mask/Viewer 0} 112} 35 1 {SurfaceView2 setViewerMask [expr ([SurfaceView2 getViewerMask]&254)+%0%*1]}}}
{DemoMaker} setVar {lastStartTime} {20}
{DemoMaker} setVar {lastEndTime} {35}
{DemoMaker} setVar {lastTimeStep} {0}
{DemoMaker} setVar {eventIdCount} {118}
{DemoMaker} setVar {eventTemplateIdCount} {182}
{DemoMaker} setVar {lengthOfNewEvents} {10.574200000000001}
...
DemoMaker eventList setOptValue 0 4
...
DemoMaker triggerTime setValue 0 0.0645067021250725
