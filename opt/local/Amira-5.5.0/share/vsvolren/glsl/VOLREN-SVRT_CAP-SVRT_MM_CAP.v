...
varying vec3    v_O10; // center of sampling cross for normal computation for the 2nd volume
...
void main()
{
    ...
    dist = u1v_VoxelSizeO.w * 0.8; 
    
    v_O10 = (gl_Vertex - 0.1 * (u1v_DeltaPosA * dist)).xyz;
}